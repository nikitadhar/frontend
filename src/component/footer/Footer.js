...
<a className="mt-30" href="index.html"><img src={logo1} alt="Logo"/></a>
...
<div className="footer-link">
<h6 className="footer-title">Product and Services</h6>
<ul>
...
<p className="text">Template Crafted by <a rel="nofollow" href="/">UIdeck</a> - UI Powered by <a el="nofollow" href="/">AyroUI</a></p>
</div>
</div>
</div> 
</div> 
