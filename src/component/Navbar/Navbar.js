...
import shape1 from "../../assets/images/header-shape.svg"
...
<li><a className="main-btn rounded-four video-popup" href={"https://youtu.be/GcRKREorGSc"}  >WATCH THE VIDEO <i className="lni-play"></i></a></li>
</ul>
</div> 
</div>
</div> 
